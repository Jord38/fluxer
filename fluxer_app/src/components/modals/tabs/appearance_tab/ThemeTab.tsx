...
} from '@app/utils/ThemeVariableUtils';
...
import {ArrowsCounterClockwiseIcon, CheckIcon, CrosshairSimpleIcon, ShareNetworkIcon} from '@phosphor-icons/react';
		...
		<>
			...
			>
				<Button
					variant="secondary"
					fitContent
					leftIcon={<CrosshairSimpleIcon size={18} />}
					onClick={() => ThemeInspectorStore.open()}
				>
					{t`Open Theme Inspector`}
				</Button>
